...
local g_tableGiftItem_EgameFee      =  								    -- 礼包物品
{
	...
	{ICON_ID = "sc_jingkuang.png",  NAME = "#{ITEM_2000_008}", PRICE = 1, GOODS_SUB_ID = "30000765967708", DESC = "#{ITEM_2000_008}"},-- 500木材
	{ICON_ID = "sc_qikuang.png",  	NAME = "#{ITEM_2000_009}", PRICE = 1, GOODS_SUB_ID = "30000765967709", DESC = "#{ITEM_2000_009}"},-- 500矿石
	{ICON_ID = "sc_jingkuang.png",  NAME = "#{ITEM_2000_010}", PRICE = 2, GOODS_SUB_ID = "30000765967710", DESC = "#{ITEM_2000_010}"},-- 1000木材
	{ICON_ID = "sc_qikuang.png",    NAME = "#{ITEM_2000_011}", PRICE = 2, GOODS_SUB_ID = "30000765967711", DESC = "#{ITEM_2000_011}"},-- 1000矿石
	{ICON_ID = "sc_jingkuang.png",  NAME = "#{ITEM_2000_012}", PRICE = 3, GOODS_SUB_ID = "30000765967712", DESC = "#{ITEM_2000_012}"},-- 1500木材
	{ICON_ID = "sc_qikuang.png",    NAME = "#{ITEM_2000_013}", PRICE = 3, GOODS_SUB_ID = "30000765967713", DESC = "#{ITEM_2000_013}"},-- 1500矿石
	{ICON_ID = "sc_jingkuang.png",  NAME = "#{ITEM_2000_014}", PRICE = 4, GOODS_SUB_ID = "30000765967714", DESC = "#{ITEM_2000_014}"},-- 2000木材
	{ICON_ID = "sc_qikuang.png",    NAME = "#{ITEM_2000_015}", PRICE = 4, GOODS_SUB_ID = "30000765967715", DESC = "#{ITEM_2000_015}"},-- 2000矿石
	{ICON_ID = "sc_jingkuang.png",  NAME = "#{ITEM_2000_016}", PRICE = 6, GOODS_SUB_ID = "30000765967716", DESC = "#{ITEM_2000_016}"},-- 3000木材
	{ICON_ID = "sc_qikuang.png",    NAME = "#{ITEM_2000_017}", PRICE = 6, GOODS_SUB_ID = "30000765967717", DESC = "#{ITEM_2000_017}"},-- 3000矿石
	{ICON_ID = "sc_jingkuang.png",  NAME = "#{ITEM_2000_018}", PRICE = 20, GOODS_SUB_ID = "30000765967718", DESC = "#{ITEM_2000_018}"},-- 10000木材
	{ICON_ID = "sc_qikuang.png",    NAME = "#{ITEM_2000_019}", PRICE = 20, GOODS_SUB_ID = "30000765967719", DESC = "#{ITEM_2000_019}"},-- 10000矿石
	{ICON_ID = "sc_jingkuang.png",  NAME = "#{ITEM_2000_020}", PRICE = 30, GOODS_SUB_ID = "30000765967720", DESC = "#{ITEM_2000_020}"},-- 15000木材
	{ICON_ID = "sc_qikuang.png",    NAME = "#{ITEM_2000_021}", PRICE = 30, GOODS_SUB_ID = "30000765967721", DESC = "#{ITEM_2000_021}"}-- 15000矿石
}
