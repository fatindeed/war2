...
{
	{ICON_ID = "sc_zdz.png",        NAME = "#{NAME_4000_028}", PRICE = 8, GOODS_SUB_ID = "30000765967701", DESC = "#{SHOP_1000_001}"},-- 震地者			
	{ICON_ID = "sc_tjzc.png",       NAME = "#{NAME_4000_030}", PRICE = 8, GOODS_SUB_ID = "30000765967702", DESC = "#{SHOP_1000_002}"},-- 突击战车 		
	{ICON_ID = "sc_lfbbc.png",      NAME = "#{NAME_4000_027}", PRICE = 8, GOODS_SUB_ID = "30000765967703", DESC = "#{SHOP_1000_003}"},-- 连发步兵车	    
	{ICON_ID = "sc_ys.png",         NAME = "#{NAME_4000_018}", PRICE = 10, GOODS_SUB_ID = "30000765967704", DESC = "#{SHOP_1000_004}"},-- 鹰隼			
	{ICON_ID = "sc_hsbd2.png",      NAME = "#{NAME_4000_021}", PRICE = 5, GOODS_SUB_ID = "30000765967705", DESC = "#{SHOP_1000_005}"},-- 火山部队		
	{ICON_ID = "sc_qxtk.png",       NAME = "#{NAME_4000_022}", PRICE = 10, GOODS_SUB_ID = "30000765967706", DESC = "#{SHOP_1000_006}"},-- 轻型坦克	
	{ICON_ID = "sc_bbc.png",        NAME = "#{NAME_4000_024}", PRICE = 10, GOODS_SUB_ID = "30000765967707", DESC = "#{SHOP_1000_007}"},-- 步兵车		
	{ICON_ID = "sc_jingkuang.png",  NAME = "#{TXSS_1000_028}", PRICE = 5, GOODS_SUB_ID = "30000765967709", DESC = "#{SHOP_1000_009}"},-- 核能晶矿
	{ICON_ID = "sc_qikuang.png",    NAME = "#{TXSS_1000_029}", PRICE = 5, GOODS_SUB_ID = "30000765967708", DESC = "#{SHOP_1000_008}"},-- 气矿	
	{ICON_ID = "sc_jingkuang.png",  NAME = "#{ITEM_2000_014}", PRICE = 3, GOODS_SUB_ID = "30000765967717", DESC = "#{ITEM_2000_014}"},--  500木材  
	{ICON_ID = "sc_qikuang.png",  	NAME = "#{ITEM_2000_015}", PRICE = 3, GOODS_SUB_ID = "30000765967718", DESC = "#{ITEM_2000_015}"},--500矿石
	{ICON_ID = "sc_jingkuang.png",  NAME = "#{ITEM_2000_017}", PRICE = 4, GOODS_SUB_ID = "30000765967720", DESC = "#{ITEM_2000_017}"},-- 800木材
	{ICON_ID = "sc_qikuang.png",    NAME = "#{ITEM_2000_021}", PRICE = 4, GOODS_SUB_ID = "30000765967721", DESC = "#{ITEM_2000_021}"},--800矿石	
	{ICON_ID = "sc_jingkuang.png",  NAME = "#{ITEM_2000_022}", PRICE = 5, GOODS_SUB_ID = "30000765967722", DESC = "#{ITEM_2000_022}"},-- 1000木材		
	{ICON_ID = "sc_qikuang.png",    NAME = "#{ITEM_2000_023}", PRICE = 5, GOODS_SUB_ID = "30000765967723", DESC = "#{ITEM_2000_023}"},-- 1000矿石
	{ICON_ID = "sc_jingkuang.png",  NAME = "#{ITEM_2000_018}", PRICE = 20, GOODS_SUB_ID = "30000765967709", DESC = "#{ITEM_2000_018}"},-- 5000木材
	{ICON_ID = "sc_qikuang.png",    NAME = "#{ITEM_2000_019}", PRICE = 20, GOODS_SUB_ID = "30000765967708", DESC = "#{ITEM_2000_019}"},-- 5000矿石
	{ICON_ID = "sc_jingkuang.png",  NAME = "#{ITEM_2000_026}", PRICE = 30, GOODS_SUB_ID = "30000765967726", DESC = "#{ITEM_2000_026}"},-- 15000木材
	{ICON_ID = "sc_qikuang.png",    NAME = "#{ITEM_2000_027}", PRICE = 30, GOODS_SUB_ID = "30000765967727", DESC = "#{ITEM_2000_027}"}-- 15000矿石		
}
